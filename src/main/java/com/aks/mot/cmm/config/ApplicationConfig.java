...
import com.aks.mot.cmm.mybatis.RefreshableSqlSessionFactoryBean;
...
public class ApplicationConfig{
	...
	/*
	 * @Bean public StatementLoggingInterceptor statementLoggingInterceptor() {
	 * return new StatementLoggingInterceptor(); }
	 */
